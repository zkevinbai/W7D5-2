...
document.addEventListener('DOMContentLoaded', function () {
  var root = document.getElementById('root'); // Window Stuff

  window.login = _util_session_api_util__WEBPACK_IMPORTED_MODULE_2__["signup"];
  window.login = _util_session_api_util__WEBPACK_IMPORTED_MODULE_2__["login"];
  window.login = _util_session_api_util__WEBPACK_IMPORTED_MODULE_2__["logout"]; // Window Stuff
